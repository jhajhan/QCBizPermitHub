 ...
 * @author Ryan Jhon
 */
public class QCBPH_HomeStatus extends javax.swing.JPanel {

    /**
     * Creates new form QCBPH_Welcome2
     */
    ...
    public QCBPH_HomeStatus(String status, Account ac, MainFrame parentFrame) {
    ...
    private void ReqPanelMouseClicked(java.awt.event.MouseEvent evt) {  
        ...
        if (status.equals(new String("To Be Processed"))) {
            parentFrame.setStatusTBP(ac);
            parentFrame.showCard("statusTBP");
        } else if (status.equals(new String("Now Processing"))) {
            parentFrame.setStatusNP(ac);
            parentFrame.showCard("statusNP");
        } else if (status.equals(new String("Processed"))) {
