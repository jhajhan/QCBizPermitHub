 ...
 * @author Ryan Jhon
 */
public class QCBPH_StatusTBP extends javax.swing.JPanel {

    /**
     * Creates new form QCBPH_StatusTBP
     */
    MainFrame parentFrame;
    Account ac;
    BusinessController bcon = new BusinessController();

    public QCBPH_StatusTBP(Account ac, MainFrame parentFrame) {
    ...
    private void initComponents() {
        ...
        jButton1.setText("CANCEL PROCESSING");
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/UPDATED_GUI_Logos/QCBPH_StatusTBP.png"))); // NOI18N
        ...
        String[] columns = {"Business", "Number of Services"}; // Adjust as per your data
        ArrayList<String[]> rowsData = bcon.countServicesPerBL(ac);
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/UPDATED_GUI_Logos/QCBPH_Status.png"))); // NOI18N
    ...
    private void StatusPanelMousePressed(java.awt.event.MouseEvent evt) {                                         
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if (response == JOptionPane.YES_OPTION) {
            System.out.println(ac.getRegNum());
            if (bcon.softDelete(ac)) {
                JOptionPane.showMessageDialog(null, "Applicaton cancelled.");
