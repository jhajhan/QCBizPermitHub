 ...
 * @author Ryan Jhon
 */
public class QCBPH_StatusAccChangePW extends javax.swing.JPanel {

    /**
     * Creates new form QCBPH_StatusAccChangePW
     */
    ...
    public QCBPH_StatusAccChangePW(Account ac, MainFrame parentFrame) {
        this.ac = ac;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
         if (ac.getPassword().equals(new String(CurrentPW.getPassword()))) {
    ...
    private void ContactUsPanelMouseClicked(java.awt.event.MouseEvent evt) {
        parentFrame.setStatusContact(ac);
        parentFrame.showCard("statusContactUs");
    }
    ...
    private void AccountPanelMouseClicked(java.awt.event.MouseEvent evt) {
        ...
        if (status.equals("To Be Processed") || status.equals("Cancelled")) {
            parentFrame.setStatusAccount(ac);
            parentFrame.showCard("statusAccount");
        } else if (status.equals("Now Processing") || status.equals("Processed")) {
