 ...
 * @author Ryan Jhon
 */
public class QCBPH_StatusAccChangeUN extends javax.swing.JPanel {

    /**
     * Creates new form QCBPH_StatusAccChangeUN
     */
    ...
    public QCBPH_StatusAccChangeUN(Account ac, MainFrame parentFrame) {
        this.ac = ac;
   ...
   // private void ContactUsPanel = 
    ...
    private void AccountPanelMouseClicked(java.awt.event.MouseEvent evt) {
        ...
        if (status.equals("To Be Processed") || status.equals("Cancelled")) {
            ...
            parentFrame.showCard("statusAccNoDeleteAcc");
        }
    }
